...
package Lab06_Hashing.Lozinki_1;
...
//        System.out.println(table);
        ...
        while(true){
            ...
            if(line.equals("KRAJ"))
                break;
            String nameSurname[] = line.split(" ");
            SLLNode<MapEntry<String, String>> temp = table.search(nameSurname[0]);
            if(temp == null || !(temp.getElement().value.equals(nameSurname[1]))){
